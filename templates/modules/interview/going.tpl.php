			...
			<div id="container">
				...
				<div class="content">
					<div class="main">
						...
						<?php 
							// Build Title
							$title  = L('modules_interview_going_ask');
						...
						<!-- 访谈内容 开始-->  
							<?php Xpipe::pagelet('interview.interviewWeiboList', array('tpl'=>'interview/answerweibo_nopage', 'wbList'=>$wbList, 'list'=>$list, 'interview'=>$interview)); ?>
						<!-- 访谈内容 结束-->
						
                        <!-- 网友提问-微博列表 开始 -->
                        	<?php Xpipe::pagelet('interview.interviewGoingAskWeiboList', array('tpl'=>'interview/askweibo_nopage', 'wbList'=>$wbList, 'list'=>$list, 'interview'=>$interview)); ?>           
                        <!-- 网友提问-微博列表 结束 -->
				...
				<div class="aside">					
                    ...
                    <div class="talk-intro">
                        <div class="hd">
                        	<p><span class="going"><?php LO('modules_interview_going_going');?></span></p>
                            <p class="time"><?php LO('modules_interview_going_time');?><span><?php echo date($interview['dateFormat'], $interview['start_time']).' - '.date($interview['dateFormat'], $interview['end_time']); ?></span></p>
                        	<p><a href="#" class="btn-recommend" rel="e:sd,t:share,m:<?php echo F('share_weibo', 'interview', $interview);?>"><?php LO('modules_interview_going_recommend');?></a></p>
                        </div>
                        <div class="bd">
                             <h4><?php LO('modules_interview_going_title');?></h4>
