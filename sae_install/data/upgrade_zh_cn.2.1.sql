...
ALTER TABLE `xwb_ad`  ADD COLUMN `remarks` TEXT COMMENT '广告使用方法描述';
/*!40000 ALTER TABLE `xwb_ad` DISABLE KEYS */;
INSERT INTO `xwb_ad` (`using`,`add_time`,`name`,`description`,`page`,`flag`,`remarks`) VALUES ('0','1306827698','页尾广告','全站','global','global_footer','建议大小，两栏800px *70px，三栏为960px*70px'),('0','1306894648','页头广告','全站','global','global_header','建议大小，两栏570px *70px，三栏为720px*70px'),('0','1306894660','右侧banner','全站','global','sidebar','建议大小，180px*任意高度');
...
ALTER TABLE `xwb_interview_wb`  ADD COLUMN `answer_weibo` TEXT CHARSET utf8 COLLATE utf8_general_ci NULL COMMENT 'json结构的微博内容';
