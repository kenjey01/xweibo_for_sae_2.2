...
INSERT INTO `xwb_ad` VALUES (1,'','0',1306827698,'頁尾廣告','全站','global','global_footer','',0,0,'建議大小，兩欄800px *70px，三欄為960px*70px'),(2,'','0',1306894648,'頁頭廣告','全站','global','global_header','',0,0 ,'建議大小，兩欄570px *70px，三欄為720px*70px'),(3,'','0',1306894660,'右側banner','全站','global','sidebar' ,'',0,0,'建議大小，180px*任意高度');
...
INSERT INTO `xwb_component_usergroups` VALUES (3,'自動關注用戶列表',1,'11:1,11:1',0),(83,'首次登入引導關注',0,NULL,0),(84,'首頁用戶推薦(他們在微博)',1,NULL,0);
...
INSERT INTO `xwb_component_users` (`group_id`,`uid`,`nickname`,`remark`,`sort_num`) VALUES("3","2173156014","自遊網旅遊攻略","自遊網旅遊攻略","1");
INSERT INTO `xwb_component_users` (`group_id`,`uid`,`nickname`,`remark`,`sort_num`) VALUES("3","2569797422","旅遊百科全書","旅遊百科全書","2");
INSERT INTO `xwb_component_users` (`group_id`,`uid`,`nickname`,`remark`,`sort_num`) VALUES("3","2568982772","旅遊美食達人","旅遊美食達人","3");
INSERT INTO `xwb_component_users` (`group_id`,`uid`,`nickname`,`remark`,`sort_num`) VALUES("83","1904178193","微博開放平臺","新浪微博API官方帳號","1");
INSERT INTO `xwb_component_users` (`group_id`,`uid`,`nickname`,`remark`,`sort_num`) VALUES("83","1662047260","SinaAppEngine","新浪SAE服務官方帳號","2");
INSERT INTO `xwb_component_users` (`group_id`,`uid`,`nickname`,`remark`,`sort_num`) VALUES("83","1076590735","xweibo官方","xweibo官方微博","3");
INSERT INTO `xwb_component_users` (`group_id`,`uid`,`nickname`,`remark`,`sort_num`) VALUES("83","2173156014","自遊網旅行攻略","自遊網旅行攻略","4");
INSERT INTO `xwb_component_users` (`group_id`,`uid`,`nickname`,`remark`,`sort_num`) VALUES("83","2588008660","自遊網客服","自遊網客服","5");
INSERT INTO `xwb_component_users` (`group_id`,`uid`,`nickname`,`remark`,`sort_num`) VALUES("83","1907727014","自遊愛攝影","自遊愛攝影","6");
INSERT INTO `xwb_component_users` (`group_id`,`uid`,`nickname`,`remark`,`sort_num`) VALUES("83","2568974212","旅行全能搜","旅行全能搜","7");
INSERT INTO `xwb_component_users` (`group_id`,`uid`,`nickname`,`remark`,`sort_num`) VALUES("83","2569797422","旅遊百科全書","旅遊百科全書","8");
INSERT INTO `xwb_component_users` (`group_id`,`uid`,`nickname`,`remark`,`sort_num`) VALUES("83","2574343370","自遊列國","自遊列國","9");
INSERT INTO `xwb_component_users` (`group_id`,`uid`,`nickname`,`remark`,`sort_num`) VALUES("83","2568982772","旅遊美食達人","旅遊美食達人","10");
INSERT INTO `xwb_component_users` (`group_id`,`uid`,`nickname`,`remark`,`sort_num`) VALUES("84","1904178193","微博開放平臺","新浪微博API官方帳號","1");
...
INSERT INTO `xwb_component_users` (`group_id`,`uid`,`nickname`,`remark`,`sort_num`) VALUES("84","2173156014","自遊網旅行攻略","自遊網旅行攻略","4");
INSERT INTO `xwb_component_users` (`group_id`,`uid`,`nickname`,`remark`,`sort_num`) VALUES("84","2588008660","自遊網客服","自遊網客服","5");
INSERT INTO `xwb_component_users` (`group_id`,`uid`,`nickname`,`remark`,`sort_num`) VALUES("84","1907727014","自遊愛攝影","自遊愛攝影","6");
INSERT INTO `xwb_component_users` (`group_id`,`uid`,`nickname`,`remark`,`sort_num`) VALUES("84","2568974212","旅行全能搜","旅行全能搜","7");
INSERT INTO `xwb_component_users` (`group_id`,`uid`,`nickname`,`remark`,`sort_num`) VALUES("84","2569797422","旅遊百科全書","旅遊百科全書","8");
INSERT INTO `xwb_component_users` (`group_id`,`uid`,`nickname`,`remark`,`sort_num`) VALUES("84","2574343370","自遊列國","自遊列國","9");
INSERT INTO `xwb_component_users` (`group_id`,`uid`,`nickname`,`remark`,`sort_num`) VALUES("84","2568982772","旅遊美食達人","旅遊美食達人","10");
...
INSERT INTO `xwb_item_groups` VALUES (1,2,83,'首次登入引導關注',0);
...
INSERT INTO `xwb_plugins` VALUES (2,'用戶首頁聚焦位','開啟該外掛程式會將站長設定的內容以圖文的形式顯示於使用者首頁中。',1),(3,'個人資料推廣位','開啟該外掛程式會將站長設定的內容以文字連結的形式顯示於使用者的個人資訊的下方。',1),(4,'登入後引導關注','開啟該外掛程式後，用戶首次登入會強制關注指定的用戶並且引導用戶其它推薦用戶。',1),(5,'建議意見','左導航會出現一個意見回饋通道',1),(6,'資料本地備份','本站備份一份微博資料',1);
...
CREATE TABLE `xwb_user_action` (
  ...
  `action_type` smallint(6) NOT NULL COMMENT '1、禁言 2、禁止用戶登入、3、清除使用者資訊（不刪除、僅是在任何情況不顯示） 4、恢復正常',
  PRIMARY KEY (`id`),
  UNIQUE KEY `sina_uid` (`sina_uid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `xwb_users` (
  ...
  `first_login` int(10) unsigned DEFAULT NULL COMMENT '首次登入時間',
  ...
  `followers_count` int(11) unsigned DEFAULT NULL COMMENT '用戶的粉絲數，每次登入時更新',
  PRIMARY KEY (`id`),
  UNIQUE KEY `sina_uid` (`sina_uid`),
  KEY `nickname` (`nickname`),
  KEY `site_uid` (`uid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='用戶表---所有登入過的用戶';
/*!40101 SET character_set_client = @saved_cs_client */;
