...
INSERT INTO `xwb_ad` VALUES (1,'','0',1306827698,'页尾广告','全站','global','global_footer','',0,0,'建议大小，两栏800px *70px，三栏为960px*70px'),(2,'','0',1306894648,'页头广告','全站','global','global_header','',0,0,'建议大小，两栏570px *70px，三栏为720px*70px'),(3,'','0',1306894660,'右侧banner','全站','global','sidebar','',0,0,'建议大小，180px*任意高度');
...
INSERT INTO `xwb_component_usergroups` VALUES (3,'自动关注用户列表',1,'11:1,11:1',0),(83,'首次登录引导关注',0,NULL,0),(84,'首页用户推荐(他们在微博)',1,NULL,0);
...
INSERT INTO `xwb_component_users` (`group_id`,`uid`,`nickname`,`remark`,`sort_num`) VALUES("3","2173156014","自游网旅游攻略","自游网旅游攻略","1");
INSERT INTO `xwb_component_users` (`group_id`,`uid`,`nickname`,`remark`,`sort_num`) VALUES("3","2569797422","旅游百科全书","旅游百科全书","2");
INSERT INTO `xwb_component_users` (`group_id`,`uid`,`nickname`,`remark`,`sort_num`) VALUES("3","2568982772","旅游美食达人","旅游美食达人","3");
INSERT INTO `xwb_component_users` (`group_id`,`uid`,`nickname`,`remark`,`sort_num`) VALUES("83","1904178193","微博开放平台","新浪微博API官方帐号","1");
INSERT INTO `xwb_component_users` (`group_id`,`uid`,`nickname`,`remark`,`sort_num`) VALUES("83","1662047260","SinaAppEngine","新浪SAE服务官方帐号","2");
INSERT INTO `xwb_component_users` (`group_id`,`uid`,`nickname`,`remark`,`sort_num`) VALUES("83","1076590735","xweibo官方","xweibo官方微博","3");
INSERT INTO `xwb_component_users` (`group_id`,`uid`,`nickname`,`remark`,`sort_num`) VALUES("83","2173156014","自游网旅行攻略","自游网旅行攻略","4");
INSERT INTO `xwb_component_users` (`group_id`,`uid`,`nickname`,`remark`,`sort_num`) VALUES("83","2588008660","自游网客服","自游网客服","5");
INSERT INTO `xwb_component_users` (`group_id`,`uid`,`nickname`,`remark`,`sort_num`) VALUES("83","1907727014","自游爱摄影","自游爱摄影","6");
INSERT INTO `xwb_component_users` (`group_id`,`uid`,`nickname`,`remark`,`sort_num`) VALUES("83","2568974212","旅行全能搜","旅行全能搜","7");
INSERT INTO `xwb_component_users` (`group_id`,`uid`,`nickname`,`remark`,`sort_num`) VALUES("83","2569797422","旅游百科全书","旅游百科全书","8");
INSERT INTO `xwb_component_users` (`group_id`,`uid`,`nickname`,`remark`,`sort_num`) VALUES("83","2574343370","自游列国","自游列国","9");
INSERT INTO `xwb_component_users` (`group_id`,`uid`,`nickname`,`remark`,`sort_num`) VALUES("83","2568982772","旅游美食达人","旅游美食达人","10");
...
INSERT INTO `xwb_component_users` (`group_id`,`uid`,`nickname`,`remark`,`sort_num`) VALUES("84","2173156014","自游网旅行攻略","自游网旅行攻略","4");
INSERT INTO `xwb_component_users` (`group_id`,`uid`,`nickname`,`remark`,`sort_num`) VALUES("84","2588008660","自游网客服","自游网客服","5");
INSERT INTO `xwb_component_users` (`group_id`,`uid`,`nickname`,`remark`,`sort_num`) VALUES("84","1907727014","自游爱摄影","自游爱摄影","6");
INSERT INTO `xwb_component_users` (`group_id`,`uid`,`nickname`,`remark`,`sort_num`) VALUES("84","2568974212","旅行全能搜","旅行全能搜","7");
INSERT INTO `xwb_component_users` (`group_id`,`uid`,`nickname`,`remark`,`sort_num`) VALUES("84","2569797422","旅游百科全书","旅游百科全书","8");
INSERT INTO `xwb_component_users` (`group_id`,`uid`,`nickname`,`remark`,`sort_num`) VALUES("84","2574343370","自游列国","自游列国","9");
INSERT INTO `xwb_component_users` (`group_id`,`uid`,`nickname`,`remark`,`sort_num`) VALUES("84","2568982772","旅游美食达人","旅游美食达人","10");
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='微访谈内容';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='保存微访谈嘉宾被提问的问题';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `xwb_item_groups` VALUES (1,2,83,'首次登录引导关注',0);
...
CREATE TABLE `xwb_micro_interview` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='Xweibo微访谈';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 CHECKSUM=1 DELAY_KEY_WRITE=1 ROW_FORMAT=DYNAMIC COMMENT='通知内容表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `xwb_notice_recipients` (
  ...
  PRIMARY KEY (`kid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_bin CHECKSUM=1 DELAY_KEY_WRITE=1 COMMENT='消息接收者记录表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `xwb_users` (
  ...
  `followers_count` int(11) unsigned DEFAULT NULL COMMENT '用户的粉丝数，每次登录时更新',
  PRIMARY KEY (`id`),
  UNIQUE KEY `sina_uid` (`sina_uid`),
